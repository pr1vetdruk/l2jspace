package ru.privetdruk.l2jspace.tool;
...
public class GameServerRegister {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner _scn = new Scanner(System.in)) {
            System.out.println();
            System.out.println();
            System.out.println("                        l2jspace game server registering");
            ...
            while (true) {
                ...
                if (_choice.equalsIgnoreCase("list")) {
                    ...
                    if (GameServerManager.getInstance().getServerNames().isEmpty())
                        System.out.println("No server names available, be sure 'SServerNames.xml' is in the LoginServer directory.");
                    else {
