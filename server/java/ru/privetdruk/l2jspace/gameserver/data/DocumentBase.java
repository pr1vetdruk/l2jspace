...
import ru.privetdruk.l2jspace.gameserver.skill.basefuncs.FuncTemplate;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.Condition;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionElementSeed;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionForceBuff;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionGameTime;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionLogicAnd;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionLogicNot;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionLogicOr;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerActiveEffectId;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerActiveSkillId;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerCharges;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerHasCastle;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerHasClanHall;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerHp;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerInvSize;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerIsHero;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerLevel;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerMp;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerPkCount;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerPledgeClass;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerRace;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerSex;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerState;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionPlayerWeight;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionSkillStats;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionTargetActiveSkillId;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionTargetHpMinMax;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionTargetNpcId;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionTargetRaceId;
import ru.privetdruk.l2jspace.gameserver.skill.conditions.ConditionUsingItemType;
import ru.privetdruk.l2jspace.gameserver.skill.effects.EffectChanceSkillTrigger;
import ru.privetdruk.l2jspace.gameserver.skill.effects.EffectTemplate;
