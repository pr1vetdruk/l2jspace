...
public class GeoEngine {
    ...
    /**
     * GeoEngine constructor. Loads all geodata files based on geo_engine.properties config.
     */
    public GeoEngine() {
        ...
        final ExProperties props = Config.initProperties(Config.GEO_ENGINE_FILE);
        int loaded = 0;
        int failed = 0;
        ...
        String[] array = Config.PATH_FIND_BUFFERS.split(";");
