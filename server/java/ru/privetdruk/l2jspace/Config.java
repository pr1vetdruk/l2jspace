...
public final class Config {
    ...
    public static final String GEO_ENGINE_FILE = "./config/geo_engine.properties";
    public static final String HEX_ID_FILE = "./config/hexid.txt";
    public static final String LOGIN_SERVER_FILE = "./config/login_server.properties";
    public static final String NPC_FILE = "./config/npc.properties";
    public static final String OFFLINE_FILE = "./config/offline_shop.properties";
    ...
    public static final String GAME_SERVER_FILE = "./config/game_server.properties";
