...
public class IpBanManager {
    ...
    protected IpBanManager() {
        // Load file.
        final Path file = Paths.get("config", "banned_ip.properties");
        if (file == null) {
            LOGGER.warn("banned_ip.properties is missing. Ban listing is skipped.");
            return;
        }
        ...
        try (Stream<String> stream = Files.lines(file)) {
            ...
            LOGGER.error("Error while reading banned_ip.properties.", e);
        }
