...
import ru.privetdruk.l2jspace.gameserver.model.zone.form.ZoneCuboid;
import ru.privetdruk.l2jspace.gameserver.model.zone.form.ZoneCylinder;
import ru.privetdruk.l2jspace.gameserver.model.zone.form.ZoneNPoly;
...
public class ZoneManager implements IXmlReader {
    ...
    public void parseDocument(Document doc, Path path) {
        ...
        try {
            zoneConstructor = Class.forName("ru.privetdruk.l2jspace.gameserver.model.zone.type." + zoneType).getConstructor(int.class);
        } catch (Exception e) {
