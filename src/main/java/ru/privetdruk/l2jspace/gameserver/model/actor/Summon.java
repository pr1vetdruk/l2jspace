...
import ru.privetdruk.l2jspace.gameserver.model.actor.move.SummonMove;
import ru.privetdruk.l2jspace.gameserver.model.actor.status.SummonStatus;
...
public abstract class Summon extends Playable {
    ...
    public final TeamAura getTeam() {
        return (getOwner() != null) ? getOwner().getTeamAura() : TeamAura.NONE;
    }
